...
class Colaborador(models.Model):
    ...
    setor = models.ForeignKey('App.Setor', on_delete=models.SET_NULL, null=True, blank=True)
    empresa = models.ForeignKey('App.Empresa', on_delete=models.SET_NULL, null=True, blank=True)
    cargo = models.ForeignKey('App.Cargo', on_delete=models.SET_NULL, null=True, blank=True)
